...
import mopgoo.huang.guolin.contact.Contact;
import mopgoo.huang.guolin.contact.ContactAdapter;
...
public class ContactActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = getContentResolver().query(uri,
                new String[]{"display_name", "phonebook_label"}, null, null, "phonebook_label");
